...
export default class Ink {
  ...
  pause(): void {
    ...
    // React 18 compat: flushSyncFromReconciler doesn't exist in 0.29
  ...
  render(node: ReactNode): void {
    ...
    // React 18 compat: use updateContainer + flushSync (React 19 has updateContainerSync + flushSyncWork)
