...
// Polyfill React.use() for React 18 (React 19 feature)
// React.use() reads promises (triggers Suspense) and contexts
if (typeof React.use !== 'function') {
  type Usable<T> = Promise<T> & { status?: string; value?: T; reason?: unknown } | { $$typeof: symbol; _currentValue: unknown };
  (React as any).use = function use<T>(usable: Usable<T>): T {
